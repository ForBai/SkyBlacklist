...
public class MainConfig extends Config {
    ...
    public boolean enableAutoKickOnJoinGuild = true;
    ...
    public boolean enableAutoLeaveOnJoinParty = true;
    ...
    public boolean enableAutoLeaveOnJoinLobby = true;
    ...
    public String fileNameSave = "blacklist.json";
    ...
    public String fileNameLoad = "blacklist.json";
    ...
    public Runnable reloadBlacklist = () -> {
